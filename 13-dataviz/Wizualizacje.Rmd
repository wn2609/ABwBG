...
# 2. Generowanie wykresu Stacked Bar Plot (skumulowane słupki)
...
#Generowanie wykresu z użyciem przykładowych danych:
...
# 10. Wykresy Venn Diagrams i UpSet Plots
...
# 11. Pathway and Annotation Plots (na przykładzie KEGG)
...
# 13. Synteny Plots (na przykładzie genoPlotR)
...
# 15. Ideograms (na przykładzie karyoploteR)
